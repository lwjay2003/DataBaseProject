...
from SystemUI.UserOrder import UserOrder
...
class PizzaOrderingApp(QMainWindow):
    ...
    def show_my_order(self):
        # Create an instance of UserOrder and display the user's orders
        user_order = UserOrder(self, self.customer_id, self.database)
        user_order.show_my_order()

    def init_checkout_screen(self):
     # Pass self (the main window) to the Checkout class
